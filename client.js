...
const _handleCaptacha = async (msg) => {
  try {
    ...
    if (msg.ev_data && msg.ev_data.tlce) {
      ...
      // Handle the error here, you might want to retry or exit gracefully
      // For example, you can call startConversation() to restart the script
      startConversation();
    }
  } catch (error) {
...
const NewCaptcha = () => {
  captchaBase64 = ""; // Clear the previous captchaBase64
